...
class Oficinista(Empleado): 
    ...
    def mostrarEmpleado(self):
        print("Tipo de Empleado: Empleado Oficina")
...
class Obrero(Empleado):    
    def __init__(self,id,nom,ced,dir,tel,fi,sueldo,anti): 
        super().__init__(id,nom,ced,dir,tel,fi,sueldo)
...
class Departamento:
    ...
    def mostrarEmpleado(self):
        print("Tipo de Empleado: Empleado Obrero")
...
class Pago_nomina:
    def __init__(self,id,empresa,sobretiempo,prestamo,fecha,sueldo,comision=0,antiguo=0,totIngre=0,iess=0,totDescu=0,liquidacion=0):
        self.id = id
    ...
    def mostrarPagoNomina(self):
        ...
        print("-----------------------------------------------------------------------------------------------------")
        print("Total Ingresos: ${}".format(self.totIngre))
        print("-----------------------------------------------------------------------------------------------------")
